...
% To verify if code is computed correctly, I traced last spin
% to get rho1 and
% also traced first spin to get rhoN and they give correct
% result. 
dlmwrite('6Spin.txt', Spin) ; 
dlmwrite('6Spin_entropy.txt', S_en) ; 
