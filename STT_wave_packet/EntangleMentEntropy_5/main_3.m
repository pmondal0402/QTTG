...
% Changing rho construction to compute 11 spin system
% data for N11 are stored in 'IE_N11.txt' (last row)
...
for nn = 1:1% length(num_s)
   N =  num_s(nn) % No. of elec or no. of spin. 
   %{
...
dlmwrite(strcat('IE_N11.txt'), data) ;
